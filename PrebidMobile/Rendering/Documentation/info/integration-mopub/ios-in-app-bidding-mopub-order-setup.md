...
- **Custom event class**: 
    - For Banner API: **PBMMoPubBannerAdapter**
    - For Interstitial API: **PBMMoPubInterstitialAdapter**
    - For Rewarded API: **PBMMoPubRewardedVideoAdapter**
    - For Native API: ***PrebidMoPubNativeAdAdapter***
- **Custom event data**: {}
...
If you integrate Native Ads not via mediation you should create regular line items
